...
DYNAMICS = """# 11_dynamics_control_transitions — Dynamics, control and transitions
...
CAPABILITY = """# TSAO capability matrix — 0.1.0-alpha.7
...
write("skills/poe/STATUS.md", STATUS)
write("skills/poe/modules/11_dynamics_control_transitions/README.md", DYNAMICS)
write("docs/CAPABILITY_MATRIX.md", CAPABILITY)
for relative in (
    ".github/workflows/bootstrap-alpha7-main-only.json",
    ".github/workflows/fix-poe-alpha7-drift-once.yml",
    ".github/workflows/fix-poe-alpha7-drift-v2-once.yml",
):
    (ROOT / relative).unlink(missing_ok=True)
print("alpha7 drift repair applied")

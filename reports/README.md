...
- `COMPLETE_DISTRIBUTION_REFERENCE.json` — explicitly `NOT_EVALUATED` until the controlled complete distribution, including excluded historical binaries, is rebuilt and cleanroom-qualified for alpha.10.
